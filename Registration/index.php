...
<head>
	...
	<title>Sole-Fit | My Account</title>
...
FitSpots</a>
 ...
 Contact</a>
   ...
   <div class="logfit jumbotron animated fadeInDown" id="top" style="height:300px;width:300px;">
     

    <div>
        <a href="index.php?logout='1'" class="btn btn-danger text-center" style="color: #fff;">Log Out</a> 
    </div>
