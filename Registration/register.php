...
FitSpots</a>
 ...
 Contact</a>
   ...
   <div class="logfit jumbotron animated fadeInDown">
       <form method="post" action="register.php">
              	<?php include('errors.php'); ?>
            <h3 class="mytyped">Create your account. <i class="fa fa-smile-o animated bounce" aria-hidden="true"></i>
            </h3> <br>
            
           <input type="text" placeholder=" Username" name="username" value="<?php echo $username; ?>" required data-validation-required-message="Please enter your name."><br> <br>
           <input type="email" placeholder=" Email ID" name="email" value="<?php echo $email; ?>" required data-validation-required-message="Please enter your email address."><br> <br>
            <input type="password" placeholder=" password" name="password_1"><br><br>
            <input type="password" placeholder=" retype password" name="password_2"><br><br>
            <button class="btn  mybutton" name="reg_user" >Sign Up</button><br><br>
