...
<?php 
	if (isset($_GET['edit'])) {
		$id = $_GET['edit'];
		$update = true;
		$record = mysqli_query($db, "SELECT * FROM diseases WHERE id=$id");
...
<?php $results = mysqli_query($db, "SELECT * FROM diseases"); ?>
...
<table class="t1">
	...
	<?php while ($row = mysqli_fetch_array($results)) { ?>
		<tr>
			...
			<td><?php echo $row['prevent']; ?></td>
			<td>
				<a href="drAD.php?edit=<?php echo $row['id']; ?>" class="edit_btn" >Edit</a>
			</td>
			<td>
...
<!--		// newly added field-->
    <input type="hidden" name="id" value="<?php echo $id; ?>">
		...
		<div class="input-group">
			<label>Causing Food Items</label>
			<input type="text" name="cause" value="<?php echo $cause; ?>">
		</div>
		<div class="input-group">
			<label>Preventing Food Items</label>
			<input type="text" name="prevent" value="<?php echo $prevent; ?>">
		</div>
		<div class="input-group">
			<?php if ($update == true): ?>
