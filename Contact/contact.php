...
<head>
	...
	<title>Sole-Fit | Contact Us</title>
...
FitSpots</a>
                    ...
                    <li id="contactz">
                        <a class="page-scroll"  href="#"><i class="fa fa-phone" aria-hidden="true"></i>
 Contact</a>
                    </li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center"><br><br>
                    ...
                    <h3 class="section-subheading text-muted">Give your valuable feedback &amp; suggestions!.</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
